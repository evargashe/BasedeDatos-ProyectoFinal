    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8"><h2>Agregar <b>Producto(Bicleta freestyle)</b></h2></div>
                    <div class="col-sm-4">
			...
			<div class="row">
				<form method="post" action="./crud/bicicleta_freestyle/controlador/insertarindex.php" enctype="multipart/form-data" >
				<div class="col-md-6">
					<label>Codigo</label>
